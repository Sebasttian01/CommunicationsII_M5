...
# Title: b_2tubes_1vector
# Author: Homero Ortega Boada
# Description: Usado para acomodar dos chorros de datos de diferentes velocidades (dos tubos) en un solo vector. N1 es el numero de espacios que ocupa en el vector, el primer tubo. N2 es para el segunto tubo
...
class b_2tubes_1vector(gr.hier_block2):
    def __init__(self, N1=5, N2=3):
        gr.hier_block2.__init__(
            self, "b_2tubes_1vector",
                gr.io_signature.makev(2, 2, [gr.sizeof_gr_complex*1, gr.sizeof_gr_complex*1]),
                gr.io_signature(1, 1, gr.sizeof_gr_complex*N1+N2),
        )
        ...
        self.blocks_streams_to_vector_0 = blocks.streams_to_vector(gr.sizeof_gr_complex*1, (N1+N2))
        ...
        self.connect((self.blocks_stream_to_streams_1, 1), (self.blocks_streams_to_vector_0, 6))
        self.connect((self.blocks_stream_to_streams_1, 0), (self.blocks_streams_to_vector_0, 5))
        self.connect((self.blocks_stream_to_streams_1, 2), (self.blocks_streams_to_vector_0, 7))
