...
class b_BERTool_Channel_ff(gr.hier_block2, Qt.QWidget):
    def __init__(self, EsN0max=20, EsN0min=0, N_snr=128, Rs=125, tipo_mod="QPSK"):
        gr.hier_block2.__init__(
            self, "b_BERTool_Channel_ff",
        ...
        self.qtgui_vector_sink_f_0_0.set_y_axis((-4), 0)
        ...
        self.blocks_stream_to_vector_0_0 = blocks.stream_to_vector(gr.sizeof_float*1, N_snr)
        self.blocks_null_source_0 = blocks.null_source(gr.sizeof_float*1)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_float*1)
        self.blocks_nlog10_ff_0_0 = blocks.nlog10_ff(1, 1, 0)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.E3TRadio_e_canal_BER_0_0 = E3TRadio.e_canal_BER(N_snr, EsN0min, EsN0max, Rs, Rs)
        self.E3TRadio_e_BERtool_0_0 = E3TRadio.e_BERtool(N_snr)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.E3TRadio_e_BERtool_0_0, 0), (self.blocks_nlog10_ff_0_0, 0))
        self.connect((self.E3TRadio_e_canal_BER_0_0, 1), (self.E3TRadio_e_BERtool_0_0, 0))
        self.connect((self.E3TRadio_e_canal_BER_0_0, 0), (self.blocks_complex_to_float_0, 0))
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.E3TRadio_e_canal_BER_0_0, 0))
        ...
        self.connect((self, 1), (self.E3TRadio_e_BERtool_0_0, 1))
        self.connect((self, 2), (self.E3TRadio_e_BERtool_0_0, 2))
