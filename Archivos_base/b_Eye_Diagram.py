...
# Description: Let you to see the eye diagram in comparison with a patron
...
class b_Eye_Diagram(gr.hier_block2, Qt.QWidget):
    def __init__(self, AlphaLineas=0.5, Delay_i=0, GrosorLineas=20, N_eyes=2, Samprate=1000, Sps=64, Title="Eye Diagramm", Ymax=2, Ymin=(-2)):
        ...
        self.connect((self, 1), (self.blocks_delay_0_3_0_0, 0))
