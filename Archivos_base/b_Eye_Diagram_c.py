...
# Title: b_Eye_Diagram_c
# Author: Done by: Homero Ortega Boada. Universidad Industrial de Santander
# Description: Let you to see the eye diagram of complex signals in comparison with a patron. Parametros usados: Delay_i - es un retardo para que el ojo se centre al gusto del usuario
...
class b_Eye_Diagram_c(gr.hier_block2, Qt.QWidget):
    def __init__(self, AlphaLineas=0.5, Delay_i=0, GrosorLineas=20, N_eyes=2, Samprate=1000, Sps=64, Title="Eye Diagramm", Ymax=2, Ymin=(-2)):
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_float_0, 0), (self.blocks_delay_0_3_0_0, 0))
        self.connect((self.blocks_complex_to_float_0, 1), (self.blocks_delay_0_3_0_0_0, 0))
        ...
        self.connect((self, 1), (self.blocks_complex_to_float_0, 0))
