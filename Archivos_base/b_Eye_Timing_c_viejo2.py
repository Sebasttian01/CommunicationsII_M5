...
# Title: b_Eye_Timing_c_viejo2
# Author: Done by: Homero Ortega Boada. Universidad Industrial de Santander
# Description: Let you to see the eye diagram of complex signals in comparison with a patron. Parametros usados:
...
class b_Eye_Timing_c_viejo2(gr.hier_block2, Qt.QWidget):
    def __init__(self, AlphaLineas=0.5, GrosorLineas=20, N_eyes=2, Retardo_Timing=0, Samprate=1000, Sps=64, Title="Eye Diagramm", Ymax=2, Ymin=(-2)):
        ...
        self.E3TRadio_diezmoppenh3_ff_0_0 = E3TRadio.diezmoppenh3_ff(Sps, Retardo_Timing)
        ...
        self.connect((self.blocks_complex_to_float_0_0, 0), (self.E3TRadio_diezmoppenh3_ff_0, 0))
        self.connect((self.blocks_complex_to_float_0_0, 1), (self.E3TRadio_diezmoppenh3_ff_0_0, 0))
    ...
    def set_Retardo_Timing(self, Retardo_Timing):
        ...
        self.E3TRadio_diezmoppenh3_ff_0_0.set_ka(self.Retardo_Timing)
