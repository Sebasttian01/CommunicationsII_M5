...
# Title: b_Eye_Timing_d_c
# Author: Done by: Homero Ortega Boada. Universidad Industrial de Santander
# Description: Let you to see the eye diagram of complex signals in comparison with a patron. Este bloque fue un experimento que ya no se usa. Ahora a usar: b_EYE_Timing_c
...
class b_Eye_Timing_d_c(gr.hier_block2, Qt.QWidget):
    def __init__(self, AlphaLineas=0.5, GrosorLineas=10, N_eyes=2, Retardo_Timing=0, Samprate=1000, Sps=64, Title="Eye Diagramm", Ymax=2, Ymin=(-2)):
        gr.hier_block2.__init__(
            self, "b_Eye_Timing_d_c",
        ...
        self._variable_qtgui_label_0_tool_bar.addWidget(Qt.QLabel("Graphic of: "))
        ...
        labels = ['Timing', '.', '.', '.', '.',
            '.', '.', '.', '.', '.']
        widths = [1, GrosorLineas, GrosorLineas, GrosorLineas, GrosorLineas,
            GrosorLineas, GrosorLineas, GrosorLineas, GrosorLineas, GrosorLineas]
        colors = ['dark blue', 'red', 'green', 'black', 'cyan',
            'magenta', 'yellow', 'dark red', 'dark green', 'blue']
        alphas = [1, AlphaLineas, AlphaLineas, AlphaLineas, AlphaLineas,
        ...
        self.connect((self.blocks_delay_0, 0), (self.qtgui_time_sink_x_0_0_0, 8))
        self.connect((self.blocks_delay_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 7))
        self.connect((self.blocks_delay_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 7))
        self.connect((self.blocks_delay_0_1, 0), (self.qtgui_time_sink_x_0_0_0, 6))
        self.connect((self.blocks_delay_0_1_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 6))
        self.connect((self.blocks_delay_0_2, 0), (self.qtgui_time_sink_x_0_0_0, 5))
        self.connect((self.blocks_delay_0_2_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 5))
        self.connect((self.blocks_delay_0_3, 0), (self.qtgui_time_sink_x_0_0_0, 4))
        self.connect((self.blocks_delay_0_3_0, 0), (self.qtgui_time_sink_x_0_0_0, 1))
        self.connect((self.blocks_delay_0_3_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.blocks_delay_0_3_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_delay_0_3_0_1, 0), (self.qtgui_time_sink_x_0_0_0_0, 1))
        self.connect((self.blocks_delay_0_3_1, 0), (self.qtgui_time_sink_x_0_0_0_0, 4))
        self.connect((self.blocks_delay_0_4, 0), (self.qtgui_time_sink_x_0_0_0, 3))
        self.connect((self.blocks_delay_0_4_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 3))
        self.connect((self.blocks_delay_0_5, 0), (self.qtgui_time_sink_x_0_0_0, 2))
        self.connect((self.blocks_delay_0_5_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 2))
        self.connect((self.blocks_delay_0_6, 0), (self.qtgui_time_sink_x_0_0_0, 9))
        self.connect((self.blocks_delay_0_6_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 9))
        self.connect((self.blocks_delay_0_7, 0), (self.qtgui_time_sink_x_0_0_0_0, 8))
