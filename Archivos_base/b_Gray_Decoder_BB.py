...
# Description: apply Gray Decoding to input byte signal. This block may be paired with b_Gray_Encoder_BB
...
class b_Gray_Decoder_BB(gr.hier_block2):
    def __init__(self, M=8):
        gr.hier_block2.__init__(
            self, "b_Gray_Decoder_BB",
        ...
        self.digital_map_bb_0 = digital.map_bb(cod_gray_inv)
