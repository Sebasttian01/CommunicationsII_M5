...
class b_PSD_VRMS_2ways(gr.hier_block2, Qt.QWidget):
    def __init__(self, Amp=1, Ensayos=1000000, N=1024, samp_rate_audio=22000):
        ...
        self.mainwidget3_grid_layout_4.addWidget(self._qtgui_number_sink_0_1_win, 3, 0, 1, 1)
        for r in range(3, 4):
            self.mainwidget3_grid_layout_4.setRowStretch(r, 1)
        for c in range(0, 1):
            self.mainwidget3_grid_layout_4.setColumnStretch(c, 1)
        ...
        self.mainwidget3_grid_layout_4.addWidget(self._qtgui_number_sink_0_0_1_win, 3, 1, 1, 1)
        for r in range(3, 4):
            self.mainwidget3_grid_layout_4.setRowStretch(r, 1)
        for c in range(1, 2):
            self.mainwidget3_grid_layout_4.setColumnStretch(c, 1)
        ...
        self.mainwidget3_grid_layout_4.addWidget(self._qtgui_number_sink_0_0_0_1_win, 3, 2, 1, 1)
        for r in range(3, 4):
            self.mainwidget3_grid_layout_4.setRowStretch(r, 1)
        for c in range(2, 3):
            self.mainwidget3_grid_layout_4.setColumnStretch(c, 1)
        ...
        self.blocks_multiply_const_vxx_0_1 = blocks.multiply_const_vff(numpy.full(N,1./N))
        ...
        self.blocks_complex_to_mag_0_0 = blocks.complex_to_mag(N)
        ...
        self.connect((self.blocks_complex_to_mag_0_0, 0), (self.blocks_multiply_const_vxx_0_1, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.qtgui_vector_sink_f_0_0, 1))
        ...
        self.connect((self.blocks_multiply_xx_0_0_0, 0), (self.blocks_nlog10_ff_0_2_0, 0))
        self.connect((self.blocks_multiply_xx_0_0_0, 0), (self.qtgui_number_sink_0_0_1, 1))
        self.connect((self.blocks_nlog10_ff_0_2, 0), (self.qtgui_number_sink_0_0_0_1, 0))
        self.connect((self.blocks_nlog10_ff_0_2_0, 0), (self.qtgui_number_sink_0_0_0_1, 1))
        ...
        self.connect((self.blocks_rms_xx_0_0_0, 0), (self.blocks_multiply_xx_0_0_0, 1))
        self.connect((self.blocks_rms_xx_0_0_0, 0), (self.blocks_multiply_xx_0_0_0, 0))
        self.connect((self.blocks_rms_xx_0_0_0, 0), (self.qtgui_number_sink_0_1, 1))
        ...
        self.connect((self, 1), (self.blocks_rms_xx_0_0_0, 0))
        self.connect((self, 1), (self.qtgui_time_sink_x_0, 1))
    ...
    def set_N(self, N):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k(numpy.full(self.N,1./(self.Ensayos*self.N)))
        self.blocks_multiply_const_vxx_0_0_0.set_k(numpy.full(self.N,1./(self.Ensayos*self.N)))
        self.blocks_multiply_const_vxx_0_1.set_k(numpy.full(self.N,1./self.N))
