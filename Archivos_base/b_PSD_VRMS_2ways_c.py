...
class b_PSD_VRMS_2ways_c(gr.hier_block2, Qt.QWidget):
    def __init__(self, Amp=1, Ensayos=1000000, N=1024, samp_rate_audio=22000):
        gr.hier_block2.__init__(
            self, "b_PSD_VRMS_2ways_c",
        ...
        self.mainwidget3_widget_5 = Qt.QWidget()
        self.mainwidget3_layout_5 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.mainwidget3_widget_5)
        self.mainwidget3_grid_layout_5 = Qt.QGridLayout()
        self.mainwidget3_layout_5.addLayout(self.mainwidget3_grid_layout_5)
        self.mainwidget3.addTab(self.mainwidget3_widget_5, 'Constelacion')
        ...
        self.mainwidget3_grid_layout_4.addWidget(self._qtgui_time_sink_x_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.mainwidget3_grid_layout_5.addWidget(self._qtgui_const_sink_x_0_0_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.mainwidget3_grid_layout_5.setRowStretch(r, 1)
        for c in range(1, 2):
            self.mainwidget3_grid_layout_5.setColumnStretch(c, 1)
        ...
        self.mainwidget3_grid_layout_5.addWidget(self._qtgui_const_sink_x_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.mainwidget3_grid_layout_5.setRowStretch(r, 1)
        for c in range(0, 1):
            self.mainwidget3_grid_layout_5.setColumnStretch(c, 1)
        ...
        self.connect((self.blocks_complex_to_mag_1, 0), (self.blocks_rms_xx_0_0, 0))
        ...
        self.connect((self, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self, 1), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self, 1), (self.qtgui_freq_sink_x_0_0, 1))
