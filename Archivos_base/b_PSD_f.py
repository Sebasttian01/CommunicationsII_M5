...
class b_PSD_f(gr.hier_block2, Qt.QWidget):
    def __init__(self, Ensayos=1000000, N=1024, Titulo='espectro', Ymax=1., samp_rate=22000):
    ...
    def set_N(self, N):
        self.N = N
        self.blocks_multiply_const_vxx_0_0.set_k(numpy.full(self.N,1./(self.Ensayos*self.N)))
        self.fft_vxx_1.set_window(window.rectangular(self.N))
