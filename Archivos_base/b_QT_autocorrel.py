...
class b_QT_autocorrel(gr.hier_block2, Qt.QWidget):
    def __init__(self, Ensayos=1000000, N=1024, Ymax=1., samp_rate_audio=22000):
        gr.hier_block2.__init__(
            self, "b_QT_autocorrel",
        ...
        self.qtgui_vector_sink_f_0.set_x_axis_units("tiempo")
        self.qtgui_vector_sink_f_0.set_y_axis_units("Watt")
        ...
        self.fft_vxx_0_0 = fft.fft_vfc(N, False, window.rectangular(N), True, 1)
        ...
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_float*1, N)
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, (int (N/2)))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.fft_vxx_0_0, 0))
    ...
    def set_N(self, N):
        self.N = N
        self.blocks_delay_0.set_dly(int((int (self.N/2))))
        self.blocks_multiply_const_vxx_0_0.set_k(numpy.full(self.N,1./(self.Ensayos*self.N)))
