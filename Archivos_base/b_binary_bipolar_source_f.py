...
# Title: b_binary_bipolar_source_f
...
class b_binary_bipolar_source_f(gr.hier_block2):
    def __init__(self, Am=1., Spb=1):
        gr.hier_block2.__init__(
            self, "b_binary_bipolar_source_f",
        ...
        self.E3TRadio_Zero_Order_Hold_0 = E3TRadio.Zero_Order_Hold(Spb)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.E3TRadio_Zero_Order_Hold_0, 0), (self, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.E3TRadio_Zero_Order_Hold_0, 0))
    ...
    def set_Spb(self, Spb):
        self.Spb = Spb
        self.E3TRadio_Zero_Order_Hold_0.set_retardo(self.Spb)
