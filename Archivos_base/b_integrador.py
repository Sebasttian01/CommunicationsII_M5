...
# Description: Hace lo mismo que el b_acum_cc, pero divide por el numero de muestras acumulados con lo cual se obtiene un integrador que se resetea cada N muestras. Es un acumulador que se resetea cada N muestras. Arranca en la muestra M.
...
class b_integrador(gr.hier_block2):
    def __init__(self, M=0, N=8):
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(1./N +0.j)
    ...
    def set_N(self, N):
        self.N = N
        self.blocks_multiply_const_vxx_0.set_k(1./self.N +0.j)
