...
# Description: Mide potencia promedio en watts y en dB a senales complejas. Tambien el Valor RMS. G_prom: es la ganancia para el filtro promediador, entre mas pequeno sea este valor, el promediado es de mas largo plazo y por tanto, el valor es mas estable
...
class b_meter_power_cc(gr.hier_block2):
    def __init__(self, G_prom=0.0001):
        gr.hier_block2.__init__(
            self, "b_meter_power_cc",
        ...
        self.blocks_rms_xx_0 = blocks.rms_cf(G_prom)
