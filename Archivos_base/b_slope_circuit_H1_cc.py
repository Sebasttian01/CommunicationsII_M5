...
# Description: Se refierea al Slope Circuit que enn el libro de Haykin, capitulo 2.7 esta representado como H1(f)
...
class b_slope_circuit_H1_cc(gr.hier_block2):
    def __init__(self, BW=1000, F_muestreo=1000, pendiente=1.):
        gr.hier_block2.__init__(
            self, "b_slope_circuit_H1_cc",
        ...
        self.connect((self.b_derivador_cc_0, 0), (self.blocks_add_xx_0, 1))
