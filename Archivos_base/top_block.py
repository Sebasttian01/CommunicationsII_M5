...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._retardo_propag_range = qtgui.Range(0, (Sps*ntaps), 1, 1, 200)
        self._retardo_propag_win = qtgui.RangeWidget(self._retardo_propag_range, self.set_retardo_propag, "Delay_Propagation_Compensation", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._fading_range = qtgui.Range(0, 1, 1/100, 1, 200)
        self._fading_win = qtgui.RangeWidget(self._fading_range, self.set_fading, "fading", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._fading_win, 2, 1, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._ch_freq_range = qtgui.Range(0, 100, 1/100, 0, 200)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._Timing_range = qtgui.Range(0, (Sps-1), 1, 1, 200)
        self._Timing_win = qtgui.RangeWidget(self._Timing_range, self.set_Timing, "Timing", "counter_slider", int, QtCore.Qt.Horizontal)
        self.menu_grid_layout_4.addWidget(self._Timing_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.menu_grid_layout_4.setRowStretch(r, 1)
        for c in range(0, 1):
            self.menu_grid_layout_4.setColumnStretch(c, 1)
        self._Pn_range = qtgui.Range(0, 1, 1/100, 0.05, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._Delay_eye_range = qtgui.Range(0, (Sps-1), 1, 0, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._Ch_phase_range = qtgui.Range(0, math.pi*2, 1/100, 0, 200)
        self._Ch_phase_win = qtgui.RangeWidget(self._Ch_phase_range, self.set_Ch_phase, "Ch_phase", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Gain_USRP_Tx_dB_range = qtgui.Range(0., 130, 1, 30., 200)
        self._Gain_USRP_Tx_dB_win = qtgui.RangeWidget(self._Gain_USRP_Tx_dB_range, self.set_Gain_USRP_Tx_dB, "Gain_USRP_Tx (dB)", "counter", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._Gain_USRP_Tx_dB_win, 3, 1, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._Gain_USRP_Rx_dB_range = qtgui.Range(0., 130, 1, 20, 200)
        self._Gain_USRP_Rx_dB_win = qtgui.RangeWidget(self._Gain_USRP_Rx_dB_range, self.set_Gain_USRP_Rx_dB, "Gain_USRP_Rx (dB)", "counter", float, QtCore.Qt.Horizontal)
    ...
    def set_bps(self, bps):
        self.bps = bps
        self.set_Rb(self.Rs*self.bps)
        self.blocks_delay_1_0_0_0.set_dly(int((self.retardo_propag*self.bps)))
    ...
    def set_retardo_propag(self, retardo_propag):
        ...
        self.blocks_delay_1_0.set_dly(int(self.retardo_propag))
        self.blocks_delay_1_0_0.set_dly(int(self.retardo_propag))
        self.blocks_delay_1_0_0_0.set_dly(int((self.retardo_propag*self.bps)))
