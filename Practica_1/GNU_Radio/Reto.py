...
# Title: Real-time Programing Challenge
...
import Reto_epy_block_2 as epy_block_2  # embedded python block



from gnuradio import qtgui

class Reto(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Real-time Programing Challenge", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Real-time Programing Challenge")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Reto")
        ...
        self.qtgui_number_sink_1_3.set_title('MEDIA')
        ...
        self.qtgui_number_sink_1_2.set_title('POTENCIA PROMEDIO')
        ...
        self.qtgui_number_sink_1_1.set_title('DESVIACION ESTANDAR')
        ...
        self.qtgui_number_sink_1_0.set_title('RMS')
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/comu2_grupoc1/Descargas/Yerba Brava - La Cumbia de los Trapos.mp4', True)
        ...
        self.connect((self.epy_block_2, 2), (self.qtgui_number_sink_1_0, 0))
        self.connect((self.epy_block_2, 4), (self.qtgui_number_sink_1_1, 0))
        self.connect((self.epy_block_2, 3), (self.qtgui_number_sink_1_2, 0))
        self.connect((self.epy_block_2, 0), (self.qtgui_number_sink_1_3, 0))
...
def main(top_block_cls=Reto, options=None):
